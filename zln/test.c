...
void test1(byte_t *code, HeapLayout *heap) {
    // globals
...
void test2(byte_t *code, HeapLayout *heap) {
    // constants
    const addr_t const_f1 = 0;
    const addr_t const_f2 = 8;
    set_float(heap->memory, const_f1, 1000.125);
    set_float(heap->memory, const_f2, 123.5);
    ...
    // code
    byte_t *code_ptr = code;
    code_ptr += emit_reg_addr(code_ptr, OPC_LD_C_F64, 1, const_f1);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_F64, 1, glb_f1);
    code_ptr += emit_reg_addr(code_ptr, OPC_LD_C_F64, 1, const_f2);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_F64, 1, glb_f2);
    *code_ptr = OPC_RET;
...
void test3(byte_t *code, HeapLayout *heap) {
    // globals
    ...
    byte_t *code_ptr = code;
    code_ptr += emit_reg_int(code_ptr, OPC_LD_C_I32, 1, 100);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_I32, 1, glb_i1);
    code_ptr += emit_reg_int(code_ptr, OPC_LD_C_I32, 1, 30);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_I32, 1, glb_i2);
    code_ptr += emit_reg_addr(code_ptr, OPC_LD_GLB_I32, 1, glb_i1);
    code_ptr += emit_reg_addr(code_ptr, OPC_LD_GLB_I32, 2, glb_i2);
    code_ptr += emit_binary_op(code_ptr, OPC_SUB_I32, 3, 1, 2);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_I32, 3, glb_i1);
    code_ptr += emit_binary_op(code_ptr, OPC_MUL_I32, 3, 1, 2);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_I32, 3, glb_i2);
    code_ptr += emit_binary_op(code_ptr, OPC_DIV_I32, 3, 1, 2);
    code_ptr += emit_reg_addr(code_ptr, OPC_ST_GLB_I32, 3, glb_i3);
    *code_ptr = OPC_RET;

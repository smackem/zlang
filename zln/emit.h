...
size_t emit_reg_reg_reg(byte_t *code, OpCode opc, byte_t r_first, byte_t r_second, byte_t r_third);
...
size_t emit_reg_reg_addr(byte_t *code, OpCode opc, byte_t r_first, byte_t r_second, addr_t addr);

...
public class CodeEditor extends CodeArea {
    ...
    private static final String[] KEYWORDS = new String[] {
            ...
            "fn", "return", "nil", "while", "where", "panic", "assert", "yield", "switch",
            "let", "var", "new", "mutable", "struct", "int", "float", "string", "bool", "byte", "union",
            "object", "void", "list", "is", "interface", "module", "uses",
    };
